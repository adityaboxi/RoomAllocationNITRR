...
export default function HODDashboard({ user }) {
 ...
 {/* Top Header Card */}
 <div className="bg-white border border-slate-200 px-8 py-5 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
 <div className="flex items-center gap-3.5">
 <div className="w-12 h-12 bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600 shadow-sm">
 ...
 <span className="text-[10px] font-bold px-2 py-0.5 bg-emerald-100 text-emerald-800 uppercase tracking-wide">
 HOD
 </span>
 </div>
 ...
 <div className="flex items-center bg-slate-100 p-1 flex-wrap self-start sm:self-auto gap-1">
 <button
 type="button"
