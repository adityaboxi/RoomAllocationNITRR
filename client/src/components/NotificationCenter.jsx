...
export default function NotificationCenter({
 ...
 return <Calendar className="w-4 h-4 text-slate-900" />;
 default:
 ...
 {/* Header Bar */}
 <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-200 px-8 py-5 shadow-sm">
 <div className="flex items-center gap-3.5">
 <Link
 to="/"
 className="w-10 h-10 bg-slate-100 flex items-center justify-center text-slate-600 hover:text-slate-900 hover:bg-slate-200 transition-colors"
 ...
 {unreadCount > 0 && (
 <span className="text-xs font-bold bg-rose-100 text-rose-700 px-2 py-0.5 ">
 {unreadCount} unread
 </span>
 )}
 </h1>
 ...
 className="inline-flex items-center gap-1.5 text-xs font-bold bg-slate-50 text-slate-800 border border-slate-300 px-3.5 py-2 hover:bg-indigo-100 transition-colors"
 >
 ...
 className="inline-flex items-center gap-1.5 text-xs font-bold bg-rose-50 text-rose-700 border border-rose-200 px-3.5 py-2 hover:bg-rose-100 transition-colors"
 >
 ...
 <div className="bg-white border border-slate-200 p-16 text-center text-slate-400">
 ...
 <div
 key={notifId}
 className={`bg-white border px-5 py-3 sm:px-8 py-5 shadow-sm flex items-start justify-between gap-4 transition-all ${
 !n.read
 ? 'border-l-4 border-l-indigo-600 border-slate-200 bg-slate-50/20 shadow-md'
 : 'border-slate-200 opacity-90'
 }`}
 >
 <div className="flex items-start gap-3 flex-1">
 <div className="p-2 bg-slate-100 flex-shrink-0 mt-0.5">
