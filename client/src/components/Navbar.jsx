...
export default function Navbar({
 ...
 >
 <div className="w-11 h-11 bg-white/10 border border-slate-700/80 p-1 flex items-center justify-center group-hover:border-indigo-400 group-hover:bg-white/20 transition-all flex-shrink-0 shadow-sm">
 <img
 src={nitrrLogo}
 alt="NIT Raipur Logo"
 ...
 <Link
 to="/notifications"
 className="relative p-2 text-slate-300 hover:text-white hover:bg-slate-800 transition-all"
 title="Notifications"
 >
 <Bell className="w-5 h-5" />
 {unreadCount > 0 && (
 <span className="absolute top-1 right-1 min-w-[18px] h-[18px] bg-rose-500 text-white text-[10px] font-extrabold px-1 flex items-center justify-center animate-pulse">
 ...
 {/* Profile / Role Badge */}
 <div className="hidden sm:flex items-center gap-2.5 bg-slate-800/80 border border-slate-700/80 px-3.5 py-1.5 ">
 ...
 type="button"
 onClick={onLogout}
 className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-300 hover:text-white bg-slate-800 hover:bg-rose-950/60 hover:border-rose-800/60 border border-slate-700 transition-all active:scale-95"
 title="Sign Out"
 >
