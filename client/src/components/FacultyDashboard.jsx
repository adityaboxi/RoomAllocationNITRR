...
export default function FacultyDashboard({ user }) {
 ...
 <div className="w-12 h-12 bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-900 shadow-sm">
 ...
 <span className="text-[10px] font-bold px-2 py-0.5 bg-indigo-100 text-indigo-800 uppercase tracking-wide">
 Faculty
 </span>
 </div>
 ...
 <div className="bg-white border border-slate-200 px-5 py-3 flex items-center justify-between shadow-sm animate-fadeIn">
