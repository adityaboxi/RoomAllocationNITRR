...
function DeleteConfirmModal({ room, onConfirm, onCancel }) {
 ...
 >
 <div className="bg-white shadow-lg w-full max-w-md border border-slate-200 overflow-hidden">
 {/* Header */}
 ...
 <div className="bg-amber-50/80 border border-amber-200/80 p-3 text-xs text-amber-900">
 ...
 disabled={loading}
 className={`w-full border px-3 py-2 pr-9 text-xs outline-none transition-all ${
 error
 ? 'border-rose-300 bg-rose-50/50 focus:ring-2 focus:ring-rose-200'
 : 'border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500'
 }`}
 />
 <button
 type="button"
 ...
 onClick={onCancel}
 disabled={loading}
 className="flex-1 px-5 py-3 bg-slate-100 text-slate-600 font-semibold text-xs hover:bg-slate-200 transition-colors disabled:opacity-50"
 >
 Cancel
 </button>
 <button
 ...
 className="flex-1 px-5 py-3 bg-rose-600 text-white font-bold text-xs hover:bg-rose-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-1.5 shadow-sm"
 >
 {loading ? (
...
export default function AdminDashboard({ user, onLogout }) {
 ...
 <div className="bg-white border border-slate-200 px-5 py-3 text-center shadow-sm">
 ...
 <div className="bg-slate-50 border border-slate-300 px-5 py-3 text-center shadow-sm">
 <p className="text-lg font-bold text-slate-800">{statusSummary.asOf}</p>
 <p className="text-[11px] font-semibold text-slate-700 uppercase tracking-wide mt-0.5">{statusSummary.day}, {statusSummary.date}</p>
 </div>
 </div>
 )}

 {/* Filters */}
 <div className="bg-white border border-slate-200 px-5 py-3 shadow-sm">
 ...
 className="px-2.5 py-1.5 border border-slate-200 text-xs font-medium bg-slate-50 focus:bg-white outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500"
 >
 ...
 className="w-full pl-8 pr-3 py-1.5 border border-slate-200 text-xs bg-slate-50 focus:bg-white outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500"
 />
 </div>
 ...
 className="p-1.5 text-slate-500 hover:text-slate-900 bg-slate-50 hover:bg-slate-50 transition-colors border border-slate-200 disabled:opacity-50"
 ...
 <div
 key={room.id}
 className={`bg-white border px-5 py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all ${
 ...
 <span className="px-1.5 py-0.5 bg-slate-100 text-slate-500 text-[10px] font-mono flex-shrink-0">
 #{room.roomNumber}
 </span>
 <span className="px-2 py-0.5 bg-slate-50 border border-slate-200 text-slate-800 text-[10px] font-semibold flex-shrink-0">
 {room.department}
 </span>
 </div>
 ...
 <div>
 <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-emerald-100 text-emerald-800 text-[11px] font-bold border border-emerald-200">
 ✅ Available
 </span>
 {room.upcoming && (
 ...
 <div className="bg-white border border-slate-200 px-8 py-5 shadow-sm space-y-3.5 sticky top-6">
 ...
 className="w-full px-2.5 py-1.5 border border-slate-200 text-xs bg-slate-50 focus:bg-white focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500 outline-none text-slate-800 font-medium"
 ...
 className="w-full px-2.5 py-1.5 border border-slate-200 text-xs bg-slate-50 focus:bg-white focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500 outline-none text-slate-800 font-medium uppercase"
 placeholder="e.g. 101"
 />
 </div>
 <div>
 ...
 className="w-full px-2.5 py-1.5 border border-slate-200 text-xs font-semibold bg-slate-50/70 text-indigo-800 outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500"
 >
 ...
 className="w-full px-2.5 py-1.5 border border-slate-200 text-xs bg-slate-50 focus:bg-white outline-none text-slate-800 font-medium"
 >
 ...
 checked
 ? 'bg-slate-50 border-slate-300 text-indigo-800 font-semibold'
 ...
 />
 {checked ? (
 <CheckSquare className="w-3.5 h-3.5 text-slate-900 flex-shrink-0" />
 ) : (
 ...
 {formError && (
 <p className="text-xs text-rose-600 bg-white border border-slate-200 px-2.5 py-1.5 flex items-center gap-1.5">
 ...
 className="flex-1 bg-slate-900 text-white font-bold py-2 text-xs flex items-center justify-center gap-1.5 hover:bg-slate-800 disabled:opacity-60 transition-colors shadow-sm shadow-indigo-100"
 >
 {formLoading ? (
 ...
 className="px-3.5 bg-slate-100 text-slate-600 font-semibold text-xs hover:bg-slate-200 transition-colors"
 >
 Cancel
 </button>
 )}
 ...
 className="bg-white border border-slate-200 px-5 py-3 flex items-center justify-between gap-3 hover:border-slate-300 hover:shadow-sm transition-all"
 >
 ...
 <span className="px-1.5 py-0.5 bg-slate-100 text-slate-600 text-[10px] font-medium flex-shrink-0">
 {room.type}
 </span>
 </div>
 ...
 {room.hasAC && <span className="bg-slate-50 text-slate-600 px-1.5 py-0.5 border border-slate-200">❄️ AC</span>}
 {room.hasProjector && <span className="bg-slate-50 text-slate-600 px-1.5 py-0.5 border border-slate-200">📽️ Projector</span>}
 {room.hasSmartBoard && <span className="bg-slate-50 text-slate-600 px-1.5 py-0.5 border border-slate-200">🖥️ SmartBoard</span>}
 {room.hasWiFi && <span className="bg-slate-50 text-slate-600 px-1.5 py-0.5 border border-slate-200">📶 Wi-Fi</span>}
 </div>
 </div>
 ...
 title="Edit room"
 className="p-1.5 text-slate-400 hover:text-slate-900 bg-slate-50 hover:bg-slate-50 transition-colors border border-slate-200"
 >
 ...
 title="Delete room"
 className="p-1.5 text-slate-400 hover:text-rose-600 bg-slate-50 hover:bg-rose-50 transition-colors border border-slate-200"
 >
