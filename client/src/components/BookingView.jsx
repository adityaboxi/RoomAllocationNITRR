...
export default function BookingView({ user }) {
 ...
 <div className="bg-white border border-slate-200 px-8 py-5 shadow-sm">
 ...
 className="w-full border border-slate-200 px-2.5 py-1.5 text-xs bg-slate-50 focus:bg-white focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500 outline-none text-slate-800 font-medium"
 >
 ...
 className={`px-2.5 py-1.5 text-xs font-semibold whitespace-nowrap transition-all flex flex-col items-center flex-shrink-0 ${
 isSelected
 ...
 {/* Holiday Alert */}
 {isHolidayDate && (
 <div className="p-3.5 bg-white border border-slate-200 flex items-center gap-3 text-amber-900">
 ...
 <div className="bg-white border border-slate-200 px-8 py-5 shadow-sm space-y-3.5">
 ...
 {/* Status Switcher */}
 <div className="flex items-center bg-slate-100 p-1 gap-1">
 <button
 type="button"
 ...
 className="w-full pl-8 pr-3 py-1.5 text-xs border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500 outline-none text-slate-900"
 />
 </div>
 ...
 className="w-full px-2.5 py-1.5 text-xs border border-slate-200 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500 outline-none text-slate-800 font-medium"
 >
 ...
 hasActiveFilters
 ? 'border-indigo-300 bg-slate-50 text-slate-800 hover:bg-indigo-100 shadow-sm'
 ...
 <div
 key={roomId}
 className={`bg-white border px-8 py-5 shadow-sm flex flex-col justify-between transition-all ${
 available
 ...
 <span
 className={`px-2 py-0.5 text-[11px] font-bold flex items-center gap-1.5 border ${
 isHolidayDate
 ...
 <>
 <span>•</span>
 <span className="px-1.5 py-0.5 bg-slate-100 text-slate-700 font-medium text-[10px]">
 {room.type}
 </span>
 </>
 )}
 ...
 {room.hasProjector && (
 <span className="bg-slate-100 text-slate-600 px-1.5 py-0.5 border border-slate-200">
 Projector
 </span>
 )}
 {room.hasAC && (
 ...
 {!available && (
 <div className="mt-3 p-2.5 bg-rose-50/80 border border-rose-200/90 text-xs text-slate-800 space-y-1">
 ...
 <span className="text-[10px] font-bold text-rose-700 bg-rose-100 px-1.5 py-0.5 border border-rose-200 uppercase tracking-wide">
 Occupied
 </span>
 </div>
 ...
 className="text-xs font-medium text-slate-900 hover:text-indigo-800"
 >
 ...
 className="w-full bg-slate-900 text-white px-3 py-2 text-xs font-bold hover:bg-slate-800 transition-colors shadow-sm shadow-indigo-100 flex items-center justify-center gap-1.5"
 >
 ...
 type="button"
 disabled
 className="w-full bg-rose-50 text-rose-700 px-3 py-2 text-xs font-bold cursor-not-allowed border border-rose-200 flex items-center justify-center gap-1.5"
 >
 ...
 {selectedRoom && (
 <div className="bg-white border-2 border-indigo-600 px-8 py-5 shadow-md">
 ...
 className="w-full border border-slate-200 px-3 py-1.5 text-xs bg-slate-50 focus:bg-white focus:ring-2 focus:ring-slate-900/20 focus:border-indigo-500 outline-none text-slate-900"
 required
 />
 </div>
 ...
 type="button"
 onClick={handleCancelSelectedRoom}
 className="bg-slate-100 text-slate-700 px-4 py-1.5 text-xs font-semibold hover:bg-slate-200 transition-colors"
 >
 Cancel
 </button>
 <button
 ...
 disabled={loading}
 className="bg-slate-900 text-white px-5 py-1.5 text-xs font-bold hover:bg-slate-800 shadow-sm transition-all disabled:opacity-50 flex items-center gap-1.5"
 >
 {loading ? (
 <>
 ...
 {myBookings.length === 0 ? (
 <div className="px-12 py-8 text-center text-slate-400 text-xs">
