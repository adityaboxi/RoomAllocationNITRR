...
export default function AuthPage({ onLoginSuccess }) {
 ...
 return (
 <div className="min-h-screen bg-slate-950 flex items-center justify-center px-5 py-3 sm:px-8 py-5 lg:px-12 py-8 font-sans">
 <div className="w-full max-w-5xl bg-slate-900 border border-slate-800 shadow-lg overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[580px]">
 {/* ---- LEFT BRANDING PANEL WITH OFFICIAL LOGO ---- */}
 <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 px-12 py-8 sm:p-10 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-800 relative overflow-hidden">
 <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-slate-500/10 blur-3xl pointer-events-none" />
 <div className="relative z-10">
 <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 bg-slate-500/10 border border-indigo-500/20 text-indigo-300 text-xs font-semibold tracking-wide mb-6">
 <Sparkles className="w-3.5 h-3.5 text-indigo-400" />
 <span>National Institute of Technology Raipur</span>
 </div>
 <div className="flex items-center gap-3.5 mb-4">
 <div className="w-14 h-14 bg-white/10 p-1.5 border border-indigo-400/30 flex items-center justify-center shadow-lg shadow-indigo-600/30 flex-shrink-0">
 <img
 src={nitrrLogo}
 alt="NIT Raipur Logo"
 ...
 <div className="w-7 h-7 bg-slate-800 flex items-center justify-center text-emerald-400 flex-shrink-0">
 <Zap className="w-4 h-4" />
 </div>
 <span>Instant slot reservation with collision prevention</span>
 </div>
 <div className="flex items-center gap-3 text-xs text-slate-300">
 <div className="w-7 h-7 bg-slate-800 flex items-center justify-center text-indigo-400 flex-shrink-0">
 ...
 {error && (
 <div className="mb-4 p-3.5 bg-white border border-slate-200 flex items-start text-rose-800 text-xs sm:text-sm font-medium animate-fadeIn">
 ...
 {successMsg && (
 <div className="mb-4 p-3.5 bg-white border border-slate-200 flex items-start text-emerald-800 text-xs sm:text-sm font-medium animate-fadeIn">
 ...
 className={`relative flex items-center p-2.5 sm:p-3 border-2 text-left transition-all duration-200 ${
 role === 'FACULTY'
 ? 'border-indigo-600 bg-slate-50/80 shadow-sm ring-2 ring-slate-900/20'
 ...
 {/* Form Mode Switcher */}
 <div className="flex bg-slate-100 p-1 mb-5">
 <button
 type="button"
 onClick={() => {
 setView('login');
 ...
 className={`flex-1 py-2 text-xs sm:text-sm font-bold transition-all ${
 view === 'login'
 ...
 <div className="text-center px-8 py-5 bg-slate-50 border border-slate-200 ">
 ...
 className="mt-4 px-5 py-3 bg-slate-950 text-white text-sm font-bold hover:bg-slate-800 shadow-md transition-all"
 >
 Go to Sign In
 </button>
 </div>
 ...
 className="w-full pl-10 pr-3.5 py-2.5 bg-slate-50/50 border border-slate-200 text-slate-900 text-sm focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all"
 required
 />
 </div>
 </div>
 ...
 className="w-full px-3.5 py-2.5 bg-slate-50/50 border border-slate-200 text-slate-900 text-sm focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all disabled:opacity-50"
 >
 {loadingDepts ? (
 ...
 className="text-xs font-medium text-slate-900 hover:text-indigo-800 transition-colors"
 >
 Forgot Password?
 </button>
 )}
 ...
 onChange={handleInputChange}
 placeholder="••••••••"
 className="w-full pl-10 pr-10 py-2.5 bg-slate-50/50 border border-slate-200 text-slate-900 text-sm focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all"
 required
 />
 <button
 type="button"
 ...
 <div className="h-1.5 w-full bg-slate-100 overflow-hidden flex gap-1">
 <div
 ...
 type="submit"
 disabled={loading}
 className="w-full mt-3 flex items-center justify-center py-3 px-4 text-white bg-slate-950 hover:bg-slate-800 font-bold text-sm shadow-md transition-all active:scale-[0.99] disabled:opacity-50 gap-2"
 >
 {loading ? (
 <>
 ...
 <div className="inline-flex items-center justify-center w-12 h-12 bg-amber-50 text-amber-600 mb-3">
 ...
 type="submit"
 disabled={loading}
 className="w-full py-3 px-4 text-white bg-slate-950 hover:bg-slate-800 font-bold text-sm shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-50"
 >
 {loading ? (
 <>
 ...
 <div className="text-center mb-6">
 <div className="inline-flex items-center justify-center w-12 h-12 bg-slate-50 text-slate-900 mb-3">
 <KeyRound className="w-6 h-6" />
 </div>
 ...
 placeholder="123456"
 maxLength="6"
 className="w-full pl-10 pr-3.5 py-2.5 bg-slate-50/50 border border-slate-200 text-slate-900 font-mono text-center tracking-widest text-lg font-bold focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all"
 required
 />
 </div>
 </div>
 ...
 className="font-semibold text-slate-900 hover:text-indigo-800 disabled:opacity-40 transition-all"
 >
 ...
 className="w-full py-3 px-4 text-white bg-slate-950 hover:bg-slate-800 font-bold text-sm shadow-md transition-all disabled:opacity-50 flex items-center justify-center gap-2"
 >
 {loading ? (
 <>
 <Loader2 className="animate-spin h-4 w-4" />
 ...
 <div className="text-center mb-6">
 <div className="inline-flex items-center justify-center w-12 h-12 bg-emerald-50 text-emerald-600 mb-3">
