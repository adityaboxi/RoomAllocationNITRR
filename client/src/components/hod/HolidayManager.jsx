...
export default function HolidayManager({ user }) {
 ...
 {/* Left Column: Form */}
 <div className="lg:col-span-4 bg-white border border-slate-200 px-8 py-5 shadow-sm">
 ...
 ? 'border-indigo-600 bg-slate-50/70 text-indigo-950 shadow-sm ring-2 ring-slate-900/20'
 ...
 className="w-full border border-slate-200 px-3.5 py-2.5 text-sm bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all resize-none"
 />
 </div>

 <div className="p-3 bg-white border border-slate-200 text-[11px] text-amber-800 leading-relaxed">
 ...
 type="submit"
 disabled={submitting}
 className="w-full bg-slate-900 text-white py-2.5 px-4 text-sm font-bold hover:bg-slate-800 transition-all shadow-sm disabled:opacity-50 flex items-center justify-center gap-2"
 >
 {submitting ? (
 <>
 ...
 {/* Right Column: Table */}
 <div className="lg:col-span-8 bg-white border border-slate-200 shadow-sm overflow-hidden flex flex-col justify-between">
 <div className="px-8 py-5 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
 <div className="flex items-center gap-2">
 <Palmtree className="w-5 h-5 text-slate-900" />
 <h3 className="text-base font-bold text-slate-900">
 ...
 <td className="px-4 py-3.5 text-sm">
 <span className="text-xs font-medium px-2 py-0.5 bg-slate-100 text-slate-700 ">
 ...
 disabled={isDeleting}
 className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 transition-colors disabled:opacity-40"
