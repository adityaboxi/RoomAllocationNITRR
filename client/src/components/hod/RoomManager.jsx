...
export default function RoomManager({ user }) {
 ...
 {/* Left Column: Form */}
 <div className="lg:col-span-4 bg-white border border-slate-200 px-8 py-5 sm:px-8 py-5 shadow-sm">
 <div className="flex items-center justify-between mb-4 pb-3 border-b border-slate-100">
 <div className="flex items-center gap-2">
 <div className="w-8 h-8 bg-slate-50 text-slate-900 flex items-center justify-center">
 ...
 className="w-full border border-slate-200 px-3.5 py-2.5 text-sm bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all"
 required
 />
 </div>
 ...
 onChange={handleChange}
 placeholder="CS-101"
 className="w-full border border-slate-200 px-3.5 py-2.5 text-sm uppercase bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all"
 required
 />
 </div>
 <div>
 ...
 value={formData.type}
 onChange={handleChange}
 className="w-full border border-slate-200 px-3 py-2.5 text-sm bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-slate-900 outline-none transition-all"
 >
 ...
 <div className="grid grid-cols-2 gap-2 bg-slate-50 p-3 border border-slate-200/80">
 ...
 onChange={handleChange}
 className=" border-slate-300 text-slate-900 focus:ring-slate-900 mr-2"
 />
 Projector
 </label>
 <label className="flex items-center text-xs font-medium text-slate-700 cursor-pointer">
 ...
 type="submit"
 disabled={loading}
 className="flex-1 bg-slate-900 text-white px-5 py-3.5 text-sm font-bold hover:bg-slate-800 transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-sm"
 >
 ...
 type="button"
 onClick={resetForm}
 className="bg-slate-100 text-slate-700 px-5 py-3.5 text-sm font-semibold hover:bg-slate-200 transition-all"
 >
 Cancel
 </button>
 )}
 ...
 {isOwner && (
 <span className="text-[10px] bg-slate-50 text-slate-800 px-1.5 py-0.5 font-bold ml-1">
 You
 </span>
 )}
 </div>
 ...
 <td className="px-4 py-3.5 text-sm">
 {!room.isAvailable ? (
 <span className="inline-flex items-center px-2.5 py-1 text-xs font-bold bg-slate-100 text-slate-600">
 ⚪ Deactivated
 </span>
 ) : isFreeNow ? (
 <span className="inline-flex items-center px-2.5 py-1 text-xs font-bold bg-emerald-100 text-emerald-800">
 🟢 Free Now
 </span>
 ) : (
 <span className="inline-flex items-center px-2.5 py-1 text-xs font-bold bg-rose-100 text-rose-800">
 🔴 Class / Booked
 </span>
 )}
 </td>
